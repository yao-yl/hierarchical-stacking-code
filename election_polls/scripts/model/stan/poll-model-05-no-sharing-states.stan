...
parameters {
  ...
  vector[T] national_mu_b_raw;
  real<lower=0> sigma_national_mu_b;
...
transformed parameters {
  ...
  national_mu_b_average = national_mu_b_raw * sigma_national_mu_b;
...
model {
  national_mu_b_raw ~ std_normal();
  sigma_national_mu_b ~ normal(0,1);
